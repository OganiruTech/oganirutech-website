...
export default function ProductsSection() {
  ...
  <div className="relative z-10 text-center max-w-3xl px-6">
    ...
    <p className="text-gray-300 text-lg md:text-xl mb-12 leading-relaxed animate-fade-in-up delay-200">
      We’re crafting something extraordinary behind the scenes. Be the first to experience it when it launches.
    </p>
    <button className="bg-emerald-500 px-8 py-3 rounded-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-emerald-500/50 animate-fade-in-up delay-400">
      Notify Me
    </button>
  </div>
